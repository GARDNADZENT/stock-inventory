...
<head>
    ...
    <style>
        ...
        body {
            background:
                radial-gradient(circle at top left, rgba(15, 118, 110, .16), transparent 24rem),
                radial-gradient(circle at bottom right, rgba(180, 83, 9, .14), transparent 22rem),
                #f4f6f8;
            color: var(--shop-ink);
            min-height: 100vh;
        }
    ...
    <form method="post" action="{{ route('login.store') }}" class="login-panel bg-white p-4">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
                ...
                <div class="text-muted small fw-semibold text-uppercase">Inventory access</div>
            </div>
        </div>
        @if($errors->any())
        ...
        <div class="mb-3">
            ...
            <input id="username" name="username" value="{{ old('username') }}" class="form-control" autocomplete="username" autofocus required>
        </div>
        <div class="mb-4">
