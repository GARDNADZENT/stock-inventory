...
<head>
    ...
    <title>Reset link sent - MAASAI SHOP</title>
    ...
    <div class="login-panel bg-white p-4 text-center">
        <div class="d-flex align-items-center justify-content-center gap-3 mb-4">
            ...
            <div class="text-start">
                ...
                <div class="text-muted small fw-semibold text-uppercase">Check your email</div>
            </div>
        </div>
        <p class="mb-2">We sent a password reset link to</p>
        <p class="fw-semibold fs-5 mb-3">{{ $email }}</p>
        <p class="text-muted small mb-4">The link expires in 60 minutes. If you don't see it, check your spam folder.</p>
        <a href="{{ route('login') }}" class="btn btn-success w-100">Back to sign in</a>
    </div>
</main>
</body>
</html>
